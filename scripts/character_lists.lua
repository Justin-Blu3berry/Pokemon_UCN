...
function character_lists.get_radar_positions(vm)
	...
	return { 
		...
		-- charmander = 0,
		squirtle = {
			["Cam 01"] = vm.vector3(1044.0, 202.0, 0.0),
		...
		abra = {
			...
			["Cam 02"] = vm.vector3(1021.0, 149.0, 0.0),
			["Cam 03"] = vm.vector3(1085.0, 237.0, 0.0),
			["Cam 04"] = vm.vector3(992.0, 164.0, 0.0),
			["Cam 05"] = vm.vector3(931.0, 181.0, 0.0),
		...
		-- lucario = 0,
		-- croagunk = 0,
		rotom = { -- TODO: make these not literally just Abra's radar positions
			["Cam 01"] = vm.vector3(1068.0, 176.0, 0.0),
			["Cam 02"] = vm.vector3(1055.0, 116.0, 0.0),
			["Cam 03"] = vm.vector3(1038.0, 237.0, 0.0),
			["Cam 04"] = vm.vector3(992.0, 164.0, 0.0),
			["Cam 05"] = vm.vector3(932.0, 154.0, 0.0),
			["Cam 06"] = vm.vector3(1129.0, 177.0, 0.0),
			["Cam 07"] = vm.vector3(1160.0, 227.0, 0.0),
			["Cam 08"] = vm.vector3(930.0, 78.0, 0.0),
			["Cam 09"] = vm.vector3(993.0, 108.0, 0.0),
			["Cam 10"] = vm.vector3(1088.0, 56.0, 0.0),
			["Cam 11"] = vm.vector3(1159.0, 114.0, 0.0),
		},
		-- giratina = 0,
		-- klinklang = 0,
		-- ["a-tales"] = 0,
